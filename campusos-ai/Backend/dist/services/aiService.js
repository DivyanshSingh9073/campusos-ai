...
const getSystemPrompt = () => 'You are CampusOS AI, a helpful and friendly AI assistant for students. Provide concise, accurate, and actionable guidance.';
/**
 * Generates an AI reply for the given user/message.
 * Kept as a small wrapper so the provider can be swapped later.
 */
export const getAiReply = async ({ userId, message, timeoutMs = 25_000 }) => {
