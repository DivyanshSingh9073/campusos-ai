...
const ChevronDown = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 pointer-events-none" aria-hidden="true">
    ...
    return (
      <div className="relative min-h-screen bg-[#0A0A0F] flex items-center justify-center px-4 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 50% 50%, rgba(34,197,94,0.15) 0%, rgba(34,197,94,0.05) 45%, transparent 70%)",
            filter: "blur(32px)",
          }}
        />
        <div className="relative text-center">
          ...
          <p className="mt-2 text-sm text-[#64748B]">Welcome, {form.name.split(" ")[0]}. You're all set.</p>
          <a
            href="/login"
            className="mt-6 inline-block rounded-xl bg-[#6C63FF] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#7C6FFF] transition-colors"
          >
            Go to Login
          </a>
        </div>
            ...
            <div className="col-span-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {BRANCHES.map((b) => (
                    <option key={b} value={b} className="bg-[#1A1A24] text-[#E2E8F0]">
                      {b}
                    </option>
                  ))}
                </select>
              ...
              <div className="flex gap-2">
                {YEARS.map((y) => (
                  <button
                    ...
                    onClick={() => {
                      setForm((p) => ({ ...p, year: y }));
                      if (errors.year) setErrors((p) => ({ ...p, year: undefined }));
                    }}
                    className={`flex-1 rounded-xl border py-2 text-xs font-medium transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#6C63FF] ${
                      form.year === y
...
}￼Enter              "radial-gradient(circle at 50% 50%, rgba(34,197,94,0.15) 0%, rgba(34,197,94,0.05) 45%, transparent 70%)",
            filter: "blur(32px)",
          }}
        />
        <div className="relative text-center">
